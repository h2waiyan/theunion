...
let patientSchema = object({
    ...
    referred_by_volunteer: string().required("Referred By is required."),
                        ...
                        <Form className="w-1/4 mx-auto mt-5 px-4 py-5 bg-white-300 rounded-lg shadow-md">
                            {!move_to_vot &&
                                <div>
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="reg_year" className="block text-gray-800 font-bold">
                                            Registration Year
                                        </label>
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="drtb_code" className="block text-gray-800 font-bold">
                                            DRTB Code
                                        </label>
                                        <Field
                                            id="drtb_code"
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="referred_by_volunteer" className="block text-gray-800 font-bold">
                                            Referred By
                                        </label>
                                        <Field
                                            ...
                                            placeholder="U Aung Aung"
                                            disabled={false}
                                            className={`mt-2 p-2 w-full rounded shadow-inner ${errors.referred_by_volunteer && touched.referred_by_volunteer
                                                ? "border-red-500 border-2"
                                                : "border"
                                                }`}
                                        />
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="patient_code" className="block text-gray-800 font-bold">
                                            Patient Code
                                        </label>
                                        <Field
                                            id="patient_code"
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="treatment_start_date" className="block text-gray-800 font-bold">
                                        ...
                                        <Field
                                            ...
                                            placeholder="2023-12-31"
                                            disabled={false}
                                            className={`mt-2 p-2 w-full rounded shadow-inner ${errors.treatment_start_date && touched.treatment_start_date
                                                ? "border-red-500 border-2"
                                                : "border"
                                                }`}
                                        />
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="treatment_regimen" className="block text-gray-800 font-bold">
                                            Treatment Regimen
                                        </label>
                            ...
                            {move_to_vot &&
                                <div>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <label htmlFor="vot_type" className="block text-gray-800 font-bold">
                                            VOT Type
                                        </label>
                                        <Field
                                            as="select"
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="vot_id" className="block text-gray-800 font-bold">
                                            Volunteer
                                        </label>
                                        <Field
                                            id="vot_id"
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="vot_start_date" className="block text-gray-800 font-bold">
                                            VOT Start Date
                                        </label>
                                        <Field
                                            as="input"
